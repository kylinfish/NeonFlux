// Icon helper - 使用 SVG 和輕量級 icon service
// 使用 Feather Icons (輕量級) 或 Heroicons 的 CDN

const ICON_CDN = 'https://cdn.jsdelivr.net/npm/feather-icons@4.29.0/dist/feather.min.js';
...
const SVG_ICONS = {
  ...
  chevronUp: '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="18 15 12 9 6 15"></polyline></svg>',
  ...
  dash: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dash-circle" viewBox="0 0 16 16"> <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/> <path d="M4 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 4 8"/> </svg>',
  tag: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2H2v10c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"></path><path d="M7 7h.01"></path></svg>',
  ...
  star: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 10.26 24 10.27 17.18 16.70 20.09 24.97 12 18.54 3.91 24.97 6.82 16.70 0 10.27 8.91 10.26 12 2"></polygon></svg>',
  layers: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 20 7 20 17 12 22 4 17 4 7 12 2"></polygon><polyline points="12 12 20 7"></polyline><polyline points="12 12 12 22"></polyline><polyline points="12 12 4 7"></polyline></svg>',
  globe: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M12 2a14.5 14.5 0 0 1 0 20"></path><path d="M12 2a14.5 14.5 0 0 0 0 20"></path><line x1="2" y1="12" x2="22" y2="12"></line></svg>',
...
// 建立 icon 按鈕
function createIconButton(iconName, title = '', className = 'btn') {
  const btn = document.createElement('button');
  btn.className = className;
  btn.title = title;
  btn.innerHTML = getSvgIcon(iconName);
  return btn;
}
